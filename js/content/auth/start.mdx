...
To set up the frontend, you have two choices:

1. *Custom:* Build your own UI using the Amplify Auth APIs. [Learn more](tbd)
2. *Drop-in:* Use the `Authenticator` Amplify UI component to get up and running with sign-in, sign-up, multi-factor auth in minutes. [Learn more](tbd) 
