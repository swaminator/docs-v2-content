---
title: Introduction
description: Authentication and Authorization with Amplify
---
...
| Topic  | Description  |
|---|---|
| Email and Password  | enter desc  |
| CAPTCHA  | enter desc    |
|Social sign-in   | enter desc    |
| OAuth2.0  |  enter desc   |
| Hosted UI  |  enter desc   |
| Amplify UI  | enter desc    |
